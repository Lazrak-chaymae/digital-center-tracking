...
export const deleteKpi = (kpiId) => axios.delete('http://localhost:8765/api/projects/kpis' + '/' + kpiId);
export const deleteRemarkOrRisk = (id) => axios.delete('http://localhost:8765/api/projects/remarks' + '/' + id);
...
export const addMilestone = (milestone, projectId) => axios.post('http://localhost:8765/api/projects' + '/' + projectId + '/milestones', milestone,{ headers: {
  'Content-Type': 'application/json',
},
});
export const addRealization = (realization, projectId) => axios.post('http://localhost:8765/api/projects' + '/' + projectId + '/upcomingRealizations', realization,{ headers: {
  'Content-Type': 'application/json',
},
});
