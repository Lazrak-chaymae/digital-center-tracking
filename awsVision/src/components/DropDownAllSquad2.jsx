...
import { updateResponsibleTeam} from '../services/Dependency';
const { useToken } = theme;


const DropDownAllSquad2 = ({ dependencyId, refresh , upTeam}) => {
    ...
    const handleSquadChoose = (squadName) => {
        updateResponsibleTeam(dependencyId, squadName)
          .then((response) => {
...
export default DropDownAllSquad2